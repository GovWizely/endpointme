...
class DataSource
  ...
  delegate :plural_filter_fields, :pluralized_filter_fields, :singular_filter_fields, :fulltext_fields, :date_fields, to: :metadata
  alias newest_version newest_version?
  alias oldest_version oldest_version?
  ...
  def as_json(_option = nil)
    methods = [:newest_version, :oldest_version]
    methods.concat([:plural_filter_fields, :pluralized_filter_fields, :singular_filter_fields,
                    :fulltext_fields, :date_fields]) unless is_consolidated?
